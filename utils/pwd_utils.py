...
viz_wheel = ['Flyer Distributer', 'Mailman',
             'Delivery Staff', 'Delivery Personnel', 'Truck Driver']
hear_autism_strangers = ['Cashier', 'Waiter', 'Call Center Worker',
                         'Customer Service', 'Bank Teller', 'Frontline Sales']
hands = ['Factory/General Worker', 'Food Processing Worker',
         'Packing Worker', 'Manufacturing Worker']
computer = ['Data Entry', 'Data Processing Clerk', 'Data Analyst',
            'Business Analyst', 'Data Engineer', 'IT Help Desk', 'Web Developer']
creativity = ['Advertising Copywriter', 'Marketing Copywriter',
              'Advertising Staff', 'Marketing Staff']
for_everyone = ['Admin Assistant', 'HR Staff',
